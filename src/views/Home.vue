...
<!--    </h1>-->
<!--    <button v-on:click="test" >got here</button>-->
<!--    <div class="mt-8">-->
<!--      <section>-->
...
<!--})-->
<!--const test= ()=>{-->
<!--  // this.$toast.success('taost working');-->
<!--  // this.$toast.error('fofofof')-->
<!--}-->
...
<!--</script>-->-->
<template>
<button @click="showToast">fdfdfdf</button>
</template>
<script>
export default {
  methods:{
    showToast(){
      // this.$toast.success('got here')
      this.$toast.error('gotooto here')
    }
  }
}
</script>